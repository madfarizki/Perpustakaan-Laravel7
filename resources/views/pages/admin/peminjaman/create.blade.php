            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <form action="">
                  ...
                  <button type="submit" onfocus=""  class="btn btn-primary d-none" id="btn">Submit</button>
                </form>
        ...
        <form action="{{ route('peminjaman.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
              <!-- <input type="hidden" name="book_id" value=""> -->
                ...
                <input type="sub" name="borrow_code" class="form-control" readonly value="{{ $kode }}" required>
              </div> 
              <div class="form-group">
